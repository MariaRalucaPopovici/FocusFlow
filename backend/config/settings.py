...
# Load variables from a local .env file (not commited to git) into the environment
...
SECRET_KEY = 'django-insecure-d0n8-@s5t)9wvsm3bdi(crb6b(1d_07q10(9(-x4@3daz8t_vs'
